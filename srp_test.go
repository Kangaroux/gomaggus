...
func Test_calcClientSKey(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		x := hexToByteArray(tc.x, false).BigInt()
		u := hexToByteArray(tc.u, false).BigInt()
...
func Test_calcU(t *testing.T) {
	...
	for _, tc := range testCases {
		clientPublicKey := hexToByteArray(tc.clientPublicKey, true).LittleEndian().BigInt()
		serverPublicKey := hexToByteArray(tc.serverPublicKey, true).LittleEndian().BigInt()
