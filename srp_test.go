...
func Test_calcServerPublicKey(t *testing.T) {
	...
	for _, tc := range testCases {
		verifier := hexToByteArray(tc.verifier, true)
		serverPrivateKey := hexToByteArray(tc.serverPrivateKey, true)
		expected := hexToByteArray(tc.expected, true).LittleEndian()
...
func Test_calcClientSKey(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		clientPrivateKey := hexToByteArray(tc.clientPrivateKey, true)
		x := hexToByteArray(tc.x, true)
		u := hexToByteArray(tc.u, true)
		expected := hexToByteArray(tc.expected, true).LittleEndian()
...
// 	for _, tc := range testCases {
// 		clientPublicKey := hexToByteArray(tc.clientPublicKey, true)   // OK
// 		verifier := hexToByteArray(tc.verifier, true)                 // OK
// 		serverPrivateKey := hexToByteArray(tc.serverPrivateKey, true) // OK
